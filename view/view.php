...
class View{
    public function entete(){
        ...
        <nav class="navbar navbar-expand-md fixed-top navbar-shrink py-3 navbar-light" id="mainNav">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php?action=accueil"><span>Brand</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    public function accueil(){
        ...
        <section class="py-4 py-md-5 my-5">
            <div class="container py-md-5">
                <div class="row">
                    <div class="col-md-6 text-center"><img class="img-fluid w-100" src="img/register.svg"></div>
    ...
    public function writeReport($donneesCompetence,$lesMatieres, $leBareme){
        ...
        <div class="mx-5">
            ...
            <div>
                <button class="btn btn-primary shadow d-block mx-auto" type="submit">Enregistrer </button>
            </div>
        </div>   
    </section>';
    $this->footer();
